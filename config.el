...
(map! :map scala-mode-map
      ...
      "C-c C-p" #'lsp-ui-doc-hide               ;; hides type under cursor as a hover
      "C-c t" #'lsp-ui-doc-glance               ;; shows tye under cursor as a hover and hides when typing
      "C-c P" #'lsp-describe-thing-at-point     ;; shows type under cursor in temp buffer below
